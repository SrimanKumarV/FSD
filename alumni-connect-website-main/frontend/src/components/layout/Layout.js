  ...
  return (
    <div className={location.pathname === '/chat' ? 'h-dvh overflow-hidden flex flex-col' : 'min-h-screen flex flex-col'}>
      ...
      <div className={`transition-all duration-300 flex-1 flex flex-col min-h-0 ${isSidebarCollapsed ? 'lg:pl-24' : 'lg:pl-64'}`}>
        ...
        {/* Page content */}
        <main className={location.pathname === '/chat' ? 'pb-24 lg:pb-0 lg:p-4 lg:pt-0 overflow-hidden flex flex-col flex-1 min-h-0' : 'py-6 pb-24 lg:pb-6 flex flex-col flex-1 min-h-0'}>
