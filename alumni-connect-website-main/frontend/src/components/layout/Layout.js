...
const Layout = ({ children }) => {
  ...
  return (
    <div className={location.pathname === '/chat' ? 'h-dvh overflow-hidden flex flex-col min-w-0' : 'min-h-screen flex flex-col overflow-x-hidden w-full min-w-0'}>
      <CommandPalette />
      ...
      {/* Main content */}
      <div className={`transition-all duration-300 flex-1 flex flex-col min-h-0 min-w-0 ${isSidebarCollapsed ? 'lg:pl-24' : 'lg:pl-64'}`}>
        {/* Top navigation */}
