...
const Chat = () => {
  ...
  return (
    <div className="w-full h-full flex-1 flex flex-col md:flex-row h-0 overflow-hidden bg-white/50 dark:bg-gray-900/50 relative">
      {/* Sidebar - Chat List */}
      ...
      {/* Main Chat Area */}
      <div className={`flex-1 flex flex-col h-0 bg-white dark:bg-gray-900 relative ${showChatList ? 'hidden md:flex' : 'flex'}`}>
        ...
        {selectedChat ? (
          <>
            ...
            {/* Messages */}
            <div id="chat-messages-scroll-container" className="flex-1 h-0 overflow-y-auto p-4 space-y-4">
              {messagesLoading ? (
