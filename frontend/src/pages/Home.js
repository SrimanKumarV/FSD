          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li><Link to="/contests" className="hover:text-white transition-colors text-primary-300 flex items-center gap-1">DevPlus Contests <span className="text-[10px] bg-primary-600 text-white px-1.5 py-0.5 rounded">NEW</span></Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-4">Support & Community</h4>
              <ul className="space-y-2 text-gray-300">
                <li><Link to="/forum" className="hover:text-white transition-colors">Help & Discussion Forum</Link></li>
                <li><Link to="/chat" className="hover:text-white transition-colors">Direct Messaging</Link></li>
                <li><Link to="/profile" className="hover:text-white transition-colors">Profile Settings</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-4">DevPlus Links</h4>
              <ul className="space-y-2 text-gray-300">
                <li><Link to="/contests" className="hover:text-white transition-colors">Developer Contests</Link></li>
                <li><a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">LinkedIn Community</a></li>
